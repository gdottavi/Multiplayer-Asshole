 ...
 */
    changeTurn(scene, currentPlayer, nextPlayer, shouldClear, pass = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield scene.GameUIHandler.updatePlayerNameColor(scene, nextPlayer, gameUIHandler_1.themeColors.yellow);
            if (currentPlayer.inGame && currentPlayer.socketId !== nextPlayer.socketId)
                yield scene.GameUIHandler.updatePlayerNameColor(scene, currentPlayer, gameUIHandler_1.themeColors.cyan);
