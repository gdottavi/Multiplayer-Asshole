 ...
 */
    changeTurn(scene, currentPlayer, nextPlayer, shouldClear, pass = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield scene.UIHandler.updatePlayerNameColor(scene, nextPlayer, themeColors.yellow);
            if (currentPlayer.inGame && currentPlayer.socketId !== nextPlayer.socketId)
                yield scene.UIHandler.updatePlayerNameColor(scene, currentPlayer, themeColors.cyan);
    ...
    handlePlayerOut(scene, currentPlayer) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.scene.UIHandler.updatePlayerNameColor(this.scene, currentPlayer, themeColors.inactiveGray);
