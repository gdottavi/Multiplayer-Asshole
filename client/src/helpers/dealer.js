    ...
    constructor(scene) {
        this.dealCards = () => {
            ...
            for (let i = 0; i < 5; i++) {
                ...
                playerCard.render(475 + (i * 100), 650, playerSprite, card_1.cardType.player);
                let opponentCard = new card_1.default(scene);
                scene.opponentCards.push(opponentCard.render(475 + (i * 100), 125, opponentSprite, card_1.cardType.opponent));
            }
        };
    }
}
